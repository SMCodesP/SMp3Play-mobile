...
import { KeyboardAvoidingView, FlatList, View, TouchableWithoutFeedback, Keyboard, Platform, StyleSheet, Text, Image } from 'react-native';
      ...
      <View style={styles.inner}>
        ...
        /> : videos.length === 0 && (
          <View style={styles.containerSongEmpty}>
            <Text style={styles.songEmpty}>Nenhuma música encontrada/pesquisada</Text>
          </View>
        )}
        <WaterfallList
