    ...
    <GlobalContainer>
      <ScrollView style={{ flex: 1 }}>
        <ImageBackground
          ...
          <View style={styles.containerImage}>
            <View style={styles.containerHeader}>
              ...
              <Text style={styles.title}>{video.title.substr(0, 26).trim()}...</Text>
            </View>
        ...
        <View style={styles.containerBody}>
          ...
          <Text style={styles.info}><Text style={styles.span}>Views:</Text> {formatNumber(video.views)}</Text>
          <Text style={styles.info}><Text style={styles.span}>Duração:</Text> {video.timestamp}</Text>
          <Text style={styles.info}><Text style={styles.span}>Postado:</Text> {video.ago}</Text>
        </View>
      </ScrollView>
    </GlobalContainer>
  );
